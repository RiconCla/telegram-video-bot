...
# ============================================
# Эскалирующие напоминания: часы (кумулятивно от первого показа гейта) до
# 1/2/3-го напоминания. После последнего бот перестаёт напоминать.
# Дефолт 12,48,168 (12ч → 2д → 7д). Пусто — отключить напоминания.
SUBSCRIPTION_REMINDER_SCHEDULE=12,48,168
```
