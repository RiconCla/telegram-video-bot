...
- 📈 **Статистика и автоматические отчёты** (NEW!)
    - Отслеживание активности пользователей
    - Автоматическая отправка отчётов администратору
    - Настраиваемая периодичность (день/неделя/месяц)
    - Список пользователей с username в формате @name
---
...
# СТАТИСТИКА И ОТЧЁТЫ
# ============================================
# Telegram ID или @username администратора для получения отчётов
# Узнайте свой ID у @userinfobot в Telegram
ADMIN_ID=478016479

# Периодичность отчётов: daily (ежедневно), weekly (еженедельно), monthly (ежемесячно)
REPORT_FREQUENCY=daily

# Время отправки отчёта (формат: ЧЧ:ММ по МСК)
REPORT_TIME=20:00

# Часовой пояс (Europe/Moscow для МСК)
